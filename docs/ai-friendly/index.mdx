---
title: AI 友好型架构
description: 构建检索友好与生成式 AI 友好的代码库，实现 10 倍开发效率
sidebar_position: 1
---
...
<style>
  ...
  .gradient-text {
    background: linear-gradient(to right, #7c3aed, #f97316, #16a34a);
			...
			<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
				<div style={{
					...
					<div style={{ gridColumn: '2', gridRow: '1' }}>
						<div
							className="flow-box bg-purple-700 clickable"
							onClick={() => onClickSection('domain-language')}
						>
							<span>统一领域语言</span>
							<svg xmlns="http://www.w3.org/2000/svg" className="flow-box-arrow" width="16" height="16" viewBox="0 0 24 24"
					...
					<div style={{ gridColumn: '1', gridRow: '2' }}>
						<div className="flow-box bg-slate-100">
							<span>问题/任务</span>
						</div>
					</div>
					<div style={{ gridColumn: '2', gridRow: '2' }}>
						<div
							className="flow-box bg-slate-100 clickable"
					...
					<div style={{ gridColumn: '3', gridRow: '2' }}>
						<div
							className="flow-box bg-orange-500 clickable"
					...
					<div style={{ gridColumn: '3', gridRow: '3' }}>
						<div
							className="flow-box bg-purple-400 clickable"
					...
					<div style={{ gridColumn: '2', gridRow: '4' }}>
						<div className="flow-box bg-purple-400">
							<span>代码库</span>
						</div>
					</div>
					<div style={{ gridColumn: '1', gridRow: '5' }}>
						<div
							className="flow-box bg-green-600 clickable"
					...
					<div style={{ gridColumn: '3', gridRow: '5' }}>
						<div
							className="flow-box bg-pink-500 clickable"
					...
					<div style={{ gridColumn: '3', gridRow: '6' }}>
						<div className="flow-box bg-green-600">
							<span>行动</span>
						</div>
					</div>
				</div>
				<div className="mt-12" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<div style={{ width: '1rem', height: '1rem', borderRadius: '0.25rem' }} className="bg-purple-700 mr-2"></div>
						<span className="text-sm text-slate-600">知识与规范</span>
					</div>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<div style={{ width: '1rem', height: '1rem', borderRadius: '0.25rem' }} className="bg-orange-500 mr-2"></div>
						<span className="text-sm text-slate-600">智能规划</span>
					</div>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<div style={{ width: '1rem', height: '1rem', borderRadius: '0.25rem' }} className="bg-pink-500 mr-2"></div>
						<span className="text-sm text-slate-600">辅助工具</span>
					</div>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<div style={{ width: '1rem', height: '1rem', borderRadius: '0.25rem' }} className="bg-green-600 mr-2"></div>
						<span className="text-sm text-slate-600">实施行动</span>
					</div>
				</div>
				<div className="mt-8 p-4 bg-slate-100 rounded-lg">
					<h3 className="font-semibold mb-2">语义化命名约定:</h3>
	...
	return (
		<div>
			<div className="text-center mb-12">
				<h1 className="gradient-text font-bold mb-4">AI 友好型架构</h1>
				<p className="text-lg text-slate-600 max-w-3xl mx-auto">
					构建检索友好与生成式 AI 友好的代码库，实现 10 倍开发效率
				</p>
			</div>

			<div className="mt-8 mb-8">
				<p className="text-center text-lg text-slate-600 mb-8">点击架构图中的任意元素，了解详细信息</p>
			...
			<div ref={domainLanguageRef} className="mt-12">
				...
				<div className="mt-12 bg-purple-50 rounded-lg p-8">
					<h3 className="text-2xl font-bold mb-6 text-center">领域语言实施步骤</h3>
					...
					<div className="grid-3">
						...
						<div className="bg-white p-5 rounded-lg shadow">
							...
							<p className="text-slate-600">使用领域术语命名类、方法和变量，确保代码反映业务语言</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div ref={plannerRef} className="mt-12">
				...
				<div className="card">
					<h3 className="text-2xl font-bold mb-6 text-center">规划器的工作原理</h3>
					...
					<div className="grid-2">
						<div>
							...
							<p className="text-slate-600 mb-4">规划器将复杂需求分解为可管理的子任务，创建清晰的执行路径</p>
					...
					<div className="mt-12 p-6 bg-orange-50 rounded-lg">
						<h4 className="font-semibold mb-4 text-center">规划器与 AI 的协同工作</h4>
						<p className="text-slate-700">
							规划器利用 AI 的能力来理解需求、分析代码库并生成实施计划。它结合了领域语言的知识，
							确保生成的计划符合团队的规范和最佳实践。通过这种方式，规划器成为开发人员和 AI 之间的桥梁，
							大大提高了开发效率和代码质量。
						</p>
					</div>
				</div>
		...
		BlogService blogService;
							...
							<div>
								...
								<div className="code-block">
		                  <pre>{`@ApiOperation(value = "Delete Blog by id")
		@DeleteMapping("/{id}")
					...
					<div className="mt-12 p-6 bg-green-50 rounded-lg">
						...
						<div className="grid-2">
							<div>
								...
								<div className="code-block">
		                  <pre>{`public void prc(List<T> l, int f) {
		...
		*/
		public void processItems(List<Item> items, int threshold) {
			...
			<div ref={retrievalToolRef} className="mt-12">
				<div className="section-header">
					<h2 className="section-title bg-pink-500">智能代码检索</h2>
			...
			<div ref={refinedQuestionRef} className="mt-12">
				<div className="section-header">
					<h2 className="section-title bg-slate-100 text-slate-800">需求精炼</h2>
					<p className="text-slate-600">将模糊的需求转化为明确、结构化的问题，提高 AI 理解能力</p>
				</div>

				<div className="card">
					<h3 className="text-2xl font-bold mb-6 text-center">问题精炼的重要性</h3>
				...
				<div className="card">
					...
					<div className="mt-12 p-6 bg-purple-50 rounded-lg">
						...
						<div className="bg-white p-4 rounded-lg">
							...
							<div className="code-block">
		                <pre>{`// Project Rules for AI Code Generation
		{
		"naming": {
		"classes": "PascalCase",
		"methods": "camelCase",
