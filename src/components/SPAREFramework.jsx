      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-8">
        ...
        <div className="bg-white p-5 rounded-lg shadow">
          ...
          <div className="mt-6 border-t border-slate-200 pt-5">
            <h5 className="font-semibold text-blue-700 mb-4 text-center">实施进度时间线</h5>
            ...
            <div className="relative">
              ...
              <div className="flex items-center mb-8 relative">
                <div className="w-1/2 pr-8 text-right">
                  <h6 className="font-medium text-blue-700">Q1-Q2 2023</h6>
                  <p className="text-sm text-slate-600">初始评估与试点部署</p>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-blue-500 text-white font-bold flex items-center justify-center z-10">1</div>
                <div className="w-1/2 pl-8">
                  <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                    <p className="text-sm text-slate-700">选择前端团队进行SPARE框架试点，建立基线指标，收集初步反馈</p>
                    <span className="inline-block mt-2 px-2 py-0.5 text-xs bg-blue-100 text-blue-700 rounded">已完成</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center mb-8 relative">
                <div className="w-1/2 pr-8 text-right">
                  <div className="bg-green-50 p-3 rounded-lg border border-green-100">
                    <p className="text-sm text-slate-700">推广至后端与平台团队，实施自动数据收集，集成CI/CD度量</p>
                    <span className="inline-block mt-2 px-2 py-0.5 text-xs bg-green-100 text-green-700 rounded">进行中</span>
                  </div>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-green-500 text-white font-bold flex items-center justify-center z-10">2</div>
                <div className="w-1/2 pl-8">
                  <h6 className="font-medium text-green-700">Q3-Q4 2023</h6>
                  <p className="text-sm text-slate-600">扩展与自动化</p>
                </div>
              </div>
              ...
              <div className="flex items-center relative">
                <div className="w-1/2 pr-8 text-right">
                  <h6 className="font-medium text-purple-700">Q1-Q2 2024</h6>
                  <p className="text-sm text-slate-600">整合与战略优化</p>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-slate-300 text-white font-bold flex items-center justify-center z-10">3</div>
                <div className="w-1/2 pl-8">
                  <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                    <p className="text-sm text-slate-700">开发综合仪表板，与战略规划整合，开发组织级AI效能指数</p>
                    <span className="inline-block mt-2 px-2 py-0.5 text-xs bg-slate-200 text-slate-700 rounded">计划中</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-blue-50 p-4 rounded-lg border border-blue-100">
            <h5 className="font-semibold text-blue-700 mb-3">实施支持资源</h5>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-3 rounded-lg border border-blue-100 flex items-start">
                ...
                <div>
                  <h6 className="font-medium text-blue-700 mb-1">实施指南文档</h6>
                  <p className="text-xs text-slate-600">包含详细步骤、最佳实践与常见问题解答</p>
                  <a href="#" className="text-xs text-blue-600 hover:underline inline-flex items-center mt-1">
                    查看文档
              ...
              <div className="bg-white p-3 rounded-lg border border-blue-100 flex items-start">
                ...
                <div>
                  <h6 className="font-medium text-green-700 mb-1">专家咨询与培训</h6>
                  <p className="text-xs text-slate-600">SPARE专家团队提供实时支持与定制培训</p>
                  <a href="#" className="text-xs text-green-600 hover:underline inline-flex items-center mt-1">
                    预约咨询
                    <ExternalLink className="h-3 w-3 ml-1" />
                  </a>
                </div>
              ...
              <div className="bg-white p-3 rounded-lg border border-blue-100 flex items-start">
                ...
                <div>
                  <h6 className="font-medium text-purple-700 mb-1">指标收集与分析工具</h6>
                  <p className="text-xs text-slate-600">用于自动收集与可视化SPARE指标的开源工具</p>
                  <a href="#" className="text-xs text-purple-600 hover:underline inline-flex items-center mt-1">
                    获取工具
                    <ExternalLink className="h-3 w-3 ml-1" />
                  </a>
                </div>
